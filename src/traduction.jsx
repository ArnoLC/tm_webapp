var traduction = {
    ...
    11: {
        ...
        INPUTSOLOB	:	"ラウンドごとに検証機から得た判定を入力してください。"	,
        ADDROUND	:	"ラウンドを追加"	,
        DELROUND	:	"最終行を消す"	,
        WINSOLO2	:	"おめでとう！ あなたの勝利です！"	,
        ...
        SHARERESULTS	:	"結果をコピーして友だちに、またはSNSでシェアしよう"	,
        PASTEYOURRESULT	:	"結果をSNSで投稿して、友だちと競い合おう！"	,
